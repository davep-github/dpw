...
(custom-set-variables
 ...
 '(filladapt-token-match-table '((citation-> citation->)
 ...
 '(filladapt-token-table '(("^" beginning-of-line)
  (">+" citation->)
  ("\\(\\w\\|[0-9]\\)[^'`\"< 	\n]*>[ 	]*" supercite-citation)
  (";+" lisp-comment)
  ("#+" sh-comment)
 ...
 '(tramp-auto-save-directory "~/.tramp-autosave.d")
 ...
 '(w3m-use-toolbar nil))
(custom-set-faces
 '(default ((t (:size "10pt" :family "Gothic"))) t)
 ...
 '(semantic-decoration-on-private-members-face ((((class color) (background light)) (:background "grey84"))))
 '(semantic-decoration-on-unknown-includes ((((class color) (background light)) (:background "#ff8080"))))
 '(semantic-highlight-edits-face ((((class color) (background light)) (:italic t))))
 '(semantic-highlight-func-current-tag-face ((((class color) (background light)) (:background "grey97"))))
