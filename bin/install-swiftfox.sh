...
echo " "
cd /opt
sudo wget http://getswiftfox.com/builds/releases/3.5.2/swiftfox-3.5.2-athlon64.tar.bz2
...
# Extract the build
sudo tar -jxf swiftfox-3.5.2-athlon64.tar.bz2
...
sudo rm /opt/swiftfox-3.5.2-athlon64.tar.bz2
