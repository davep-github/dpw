...
#db=dbt
dppydb.prep()
host_db = dppydb.load(wild='host_info')
...
def lookup_item(info_item, not_found_string='-', dumper=Def_dumper,
                locale_search=True, default_search=True,
...
for item in items + args:
    try:
        ...
        lookup_item(item, not_found_string=nfs, locale_search=locale_search,
