...
import os, sys, string, stat, getopt, filecmp, sre
...
victim_regexp = sre.compile ("_copy_|[^a-zA-Z](bak|old|bad)([^a-zA-Z]|$)")
        ...
        if ans in ["y", "yes", ""]:
		    ...
		    dp_io.eprintf("WARNING: %s vanished\n", f)
                    ...
                    try:
                        ...
                        dp_io.eprintf("WARNING: OSError: %s\n", e)
