...
(custom-set-faces
 ...
 '(dired-directory ((t (:foreground "deep sky blue" :weight semi-bold))))
 ...
 '(elpy-breakpoint-fringe-face ((t (:foreground "deep pink" :box (:line-width 1 :color "deep pink" :style released-button)))))
