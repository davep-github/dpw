...
(let ((ct '((class color) (min-colors 89)))
  ...
  (let* ((bg              "#1b182c")
    ...
    (custom-theme-set-faces
     ...
     `(trailing-whitespace    ((,c (:background "#000042" :strike-through nil :underline (:color "magenta" :style wave))))
