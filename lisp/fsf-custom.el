...
(custom-set-faces
 ...
 '(isearch ((t (:background "blue" :foreground "white" :weight bold))))
 '(lazy-highlight ((t (:background "LightSkyBlue1" :foreground "black"))))
 '(minibuffer-prompt ((t (:foreground "#91ddff"))))
 ...
 '(region ((t (:background "LightSkyBlue1" :distant-foreground "black" :foreground "black")))))
