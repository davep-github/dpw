...
(package-provide 'igrep :version 1.16 :author-version "2.111" :type 'regular)
...
the file name component of FILES (and whose contents match REGEX)." t nil)
...
See `\\[igrep]' for a description of PROGRAM, REGEX, and OPTIONS." t nil)
