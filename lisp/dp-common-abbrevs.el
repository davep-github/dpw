...
(defconst dp-common-abbrevs
  '(((("dev" "development" "develop" "device")
    ...
    ((("alt" "alternative" "alternate") 'circular) dp-manual)
    ((("emacs" "xemacs" "XEmacs" "Emacs") 'circular) dp-manual)
    ((("acc" "accurate" "accuracy") 'circular) dp-manual)
    ((("res" "resource") 'circular) dp-manual)
    ((("sch" "schematics" "schematic" "scheme" "schedule" ) 'circular) dp-manual)
