	...
	char* argv[])
{
	...
	blah;
	fun1();
 	int hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh = 0;
	FILE* blah;
	int *bbb;
	int **blahp;
	/*
	 * following line should be a whitespace violation. But is it leading,
	 * trailing or both?
	 */
	
	/* The following as well, except we know it's trailing. */
	x = 5;         
	int *what_a_foolish_style;
	/*   */
        /*     */

	if (a) {
                amma_ganna_wanna_use_this(aaaaaaaaaaaaaaaaaa,
                bbbbbbbbbbbbbbbbb, cnnnnn9999999999999, ddddddddd);
	if (a) {
